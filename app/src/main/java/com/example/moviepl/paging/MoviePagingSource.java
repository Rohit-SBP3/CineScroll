package com.example.moviepl.paging;
...
import com.example.moviepl.api.APIClient;
import com.example.moviepl.model.Movie;
import com.example.moviepl.model.MovieResponse;
...
public class MoviePagingSource extends RxPagingSource<Integer, Movie> {
    ...
    public Single<LoadResult<Integer, Movie>> loadSingle(@NonNull LoadParams<Integer> loadParams) {
        try{
            ...
            return APIClient.getApiInterface().getMovieByPage(page)
